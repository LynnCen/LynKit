 ...
 * @source figma
 */
const Iconrecently = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  ...
  return (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M11.375 7H12.875V12H11.375V7Z" fill={color} />
      <path d="M11.375 12H16.375V13.5H11.375V12Z" fill={color} />
    </svg>
  );
});

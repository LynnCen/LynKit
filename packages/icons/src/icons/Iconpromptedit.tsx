 ...
 * @source figma
 */
const Iconpromptedit = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M15 4.72498H2.00586V3.22498H15V4.72498Z" fill={color} />
      <path d="M15 9.6438H2.00586V8.1438H15V9.6438Z" fill={color} />
      <path d="M2.00586 14.5627H10.4492V13.0627H2.00586V14.5627Z" fill={color} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"

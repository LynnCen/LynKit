 ...
 * @source figma
 */
const Iconcompare = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  ...
  return (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M14.2461 4.25H16.317V5.75H14.2461V4.25Z" fill={color} />
      <path
        ...
        fill={color}
      />
      <path d="M21 12.7499V15.083L19.5 15.083V12.7499H21Z" fill={color} />
      <path d="M19.5 11.2499V8.91698H21V11.2499H19.5Z" fill={color} />
      <path
        d="M19.5 6V7.41698H21V6C21 5.0335 20.2165 4.25 19.25 4.25H17.817V5.75H19.25C19.3881 5.75 19.5 5.86193 19.5 6Z"
        fill={color}
      />
      <path d="M14.2461 18.25H16.317V19.75H14.2461V18.25Z" fill={color} />
    </svg>
  );
});

 ...
 * @source figma
 */
const Iconalipaystatic = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
...
Iconalipaystatic.displayName = 'Iconalipaystatic';

export default Iconalipaystatic;

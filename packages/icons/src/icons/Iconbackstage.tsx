 ...
 * @source figma
 */
const Iconbackstage = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d="M11 8.75H7V7.25H11V8.75Z" fill={color} />
      <path d="M7 12.25H14V10.75H7V12.25Z" fill={color} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"

 ...
 * @source figma
 */
const Iconcloudsaveloading = forwardRef<SVGSVGElement, IconProps>((props, ref) => {
  ...
  return (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M9.75 18H11.25V19.5H9.75V18Z" fill={color} />
      <path d="M14.25 18H12.75V19.5H14.25V18Z" fill={color} />
      <path d="M15.75 18H17.25V19.5H15.75V18Z" fill={color} />
      <path d="M8.25 18H6.75V19.5H8.25V18Z" fill={color} />
    </svg>
  );
});
